...
class GetOfflineResultRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetOfflineResultRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetOfflineResultRequest
    let len;
    let data = new GetOfflineResultRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetOfflineResultRequest(null);
...
class GetOfflineResultResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetOfflineResultResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetOfflineResultResponse
    let len;
    let data = new GetOfflineResultResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetOfflineResultResponse(null);
...
module.exports = {
  Request: GetOfflineResultRequest,
  Response: GetOfflineResultResponse,
  md5sum() { return '28bc8539466b604fc9101f0b3a34c375'; },
  datatype() { return 'xf_mic_asr_offline/GetOfflineResult'; }
};
