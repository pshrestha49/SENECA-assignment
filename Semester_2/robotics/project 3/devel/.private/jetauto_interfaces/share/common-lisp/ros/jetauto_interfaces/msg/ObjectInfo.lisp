...
(cl:defmethod cl:initialize-instance :after ((m <ObjectInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetauto_interfaces-msg:<ObjectInfo> is deprecated: use jetauto_interfaces-msg:ObjectInfo instead.")))

(cl:ensure-generic-function 'class_name-val :lambda-list '(m))
(cl:defmethod class_name-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetauto_interfaces-msg:class_name-val is deprecated.  Use jetauto_interfaces-msg:class_name instead.")
  (class_name m))

(cl:ensure-generic-function 'box-val :lambda-list '(m))
(cl:defmethod box-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetauto_interfaces-msg:box-val is deprecated.  Use jetauto_interfaces-msg:box instead.")
  (box m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <ObjectInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetauto_interfaces-msg:score-val is deprecated.  Use jetauto_interfaces-msg:score instead.")
  (score m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ObjectInfo>)))
  ...
  (cl:format cl:nil "string class_name~%int32[] box~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ObjectInfo)))
  "Returns full string definition for message of type 'ObjectInfo"
  (cl:format cl:nil "string class_name~%int32[] box~%float32 score~%~%~%"))
