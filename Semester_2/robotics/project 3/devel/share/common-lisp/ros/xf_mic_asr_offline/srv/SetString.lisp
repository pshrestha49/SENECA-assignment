...
(cl:defmethod cl:initialize-instance :after ((m <SetString-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetString-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline-srv:<SetString-request> is deprecated: use xf_mic_asr_offline-srv:SetString-request instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SetString-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xf_mic_asr_offline-srv:data-val is deprecated.  Use xf_mic_asr_offline-srv:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetString-request>)))
  ...
  "xf_mic_asr_offline/SetStringRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetString-request)))
  "Returns string type for a service object of type 'SetString-request"
  "xf_mic_asr_offline/SetStringRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetString-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetString-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xf_mic_asr_offline-srv:<SetString-response> is deprecated: use xf_mic_asr_offline-srv:SetString-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetString-response>)))
  ...
  "xf_mic_asr_offline/SetStringResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetString-response)))
  "Returns string type for a service object of type 'SetString-response"
  "xf_mic_asr_offline/SetStringResponse")
